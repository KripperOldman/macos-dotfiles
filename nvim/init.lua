...
local on_attach = function(client, bufnr)
  ...
  nmap('<leader>csd', require('telescope.builtin').lsp_document_symbols, 'Symbols [D]ocument')
  nmap('<leader>csw', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Symbols [W]orkspace')
  ...
  nmap('<leader>cwa', vim.lsp.buf.add_workspace_folder, 'Workspace [A]dd Folder')
  nmap('<leader>cwr', vim.lsp.buf.remove_workspace_folder, 'Workspace [R]emove Folder')
